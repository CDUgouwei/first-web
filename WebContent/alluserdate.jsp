...
<body>
	...
	<div class="mid">
		...
		<p style="font-size: 25px;margin-top: 5%;">员工列表</p>
			...
			<div ><p id="npage" style="display:inline-block;font-size: 20px;margin-left: 70%;margin-top: 1%">当前页数:<%=session.getAttribute("npage")%></p>
			<a id="b1"  class="bu" href="all2?b=b1"></a>
			<a id="b2"  class="bu" href="all2?b=b2"></a>
			<a id="b3" class="bu" href="all2?b=b3"></a>
			</div>
		</div>
